...
def convert_to_mp4(input_file: str, output_file: str = None):
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Convierte MKV a MP4")
    parser.add_argument("--file", required=True, help="Fichero de entrada (.mkv)")
    parser.add_argument("--output", help="Fichero de salida (opcional)")
    args = parser.parse_args()

    convert_to_mp4(args.file, args.output)